...
// tailwind.config.js
module.exports = {
  darkMode: 'class', // включаем режим тёмной темы
  theme: {
    extend: {
      colors: {
        primary: '#3B82F6',         // синий – основной цвет интерфейса
        'primary-dark': '#1E40AF',  // тёмный вариант для темной темы
        secondary: '#10B981',       // зелёный – дополнительный акцент
        background: '#F9FAFB',      // светлый фон
        'background-dark': '#1F2937',// тёмный фон (чаще gray-800)
        foreground: '#111827',      // цвет текста на светлом фоне
        'foreground-dark': '#F3F4F6'// цвет текста на тёмном фоне
      }
    }
  }
}
